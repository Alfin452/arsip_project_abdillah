<x-app-layout>
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-2xl font-bold text-slate-800">Laporan Surat Masuk</h2>
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('reports.print.incoming', ['start_date' => $startDate, 'end_date' => $endDate]) }}" target="_blank" class="px-6 py-2 bg-indigo-600 text-white rounded-xl font-bold text-sm hover:bg-indigo-700 shadow-lg shadow-indigo-500/30 flex items-center gap-2">
            ...
            <table class="w-full text-left text-sm text-slate-600">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr>
                        ...
                        <td class="px-4 py-3 font-bold">{{ $item->origin }}</td>
